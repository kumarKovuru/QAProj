...
namespace eMids.QA.Application.Test
{
    ...
    [NUnit.Framework.DescriptionAttribute("Component testing of patient")]
    public partial class ComponentTestingOfPatientFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Component testing of patient", "Description:  The purpose of this feature is to create, Update and Delete the pat" +
                    "ient.", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.DescriptionAttribute("1 New Patient created successfully with valid data for all the fields")]
        [NUnit.Framework.CategoryAttribute("mytag")]
        public virtual void _1NewPatientCreatedSuccessfullyWithValidDataForAllTheFields()
        {
            string[] tagsOfScenario = new string[] {
                    "mytag"};
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("1 New Patient created successfully with valid data for all the fields", null, new string[] {
                        "mytag"});
#line 5
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("2 Get newly created Patient")]
        [NUnit.Framework.CategoryAttribute("mytag")]
        public virtual void _2GetNewlyCreatedPatient()
        {
            string[] tagsOfScenario = new string[] {
                    "mytag"};
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("2 Get newly created Patient", null, new string[] {
                        "mytag"});
#line 18
 this.ScenarioInitialize(scenarioInfo);
#line hidden
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("3 Patient Updated successfully with valid data for all the fields")]
        [NUnit.Framework.CategoryAttribute("mytag")]
        public virtual void _3PatientUpdatedSuccessfullyWithValidDataForAllTheFields()
        {
            string[] tagsOfScenario = new string[] {
                    "mytag"};
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("3 Patient Updated successfully with valid data for all the fields", null, new string[] {
                        "mytag"});
#line 23
  this.ScenarioInitialize(scenarioInfo);
#line hidden
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("4 Get newly Updated Patient")]
        [NUnit.Framework.CategoryAttribute("mytag")]
        public virtual void _4GetNewlyUpdatedPatient()
        {
            string[] tagsOfScenario = new string[] {
                    "mytag"};
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("4 Get newly Updated Patient", null, new string[] {
                        "mytag"});
#line 36
   this.ScenarioInitialize(scenarioInfo);
#line hidden
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("5 Patient Deleted successfully with Patient Id")]
        [NUnit.Framework.CategoryAttribute("mytag")]
        public virtual void _5PatientDeletedSuccessfullyWithPatientId()
        {
            string[] tagsOfScenario = new string[] {
                    "mytag"};
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("5 Patient Deleted successfully with Patient Id", null, new string[] {
                        "mytag"});
#line 41
    this.ScenarioInitialize(scenarioInfo);
#line hidden
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("6 Get newly Deleted Patient")]
        [NUnit.Framework.CategoryAttribute("mytag")]
        public virtual void _6GetNewlyDeletedPatient()
        {
            string[] tagsOfScenario = new string[] {
                    "mytag"};
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("6 Get newly Deleted Patient", null, new string[] {
                        "mytag"});
#line 46
 this.ScenarioInitialize(scenarioInfo);
#line hidden
